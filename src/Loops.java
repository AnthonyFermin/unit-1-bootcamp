...
public class Loops
{
    ...
    public static void digits()
    {
        ...
        for(int i = 1; i < 10; i++)
        {
            ...
            {
                int sum = i + j;
                System.out.println(Integer.toString(i) + Integer
                        .toString(j) + ", " + i + "+" + j + " = " + sum);
            }
        }
    }
    ...
    public static void numberPuzzle()
    {
        ...
        for(int i = 30; i < 60; i++)
        {
            ...
            for(int j = 30; j > 9; j--)
            {
                ...
                {
                    System.out.println(
                            "The sum of " + i + " and " + j + " is 60 and their difference is 14.");
                }
    ...
    public static String notReplace(String toReplace)
    {
        ...
        for(int i = 1; i < toReplace.length() - 1; i++)
        {
            ...
            if(toReplace.substring(i, i + 2).equals("is"))
            {
                ...
                if(! Character.isLetter(toReplace.charAt(i - 1)) && ! Character
                        .isLetter(toReplace.charAt(i + 2)))
                {
                    isReplaced += "is not";
                    i++;
                }
    ...
    public static void main(String args[])
    {
        ...
        do
        {
            ...
            System.out
                    .print("Enter the exercise number to run the exercise or enter a negative number to quit: ");
